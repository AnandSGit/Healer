...
Follow the **Stack Auto-Detection Protocol** in `commands/_enforcement.md`. The detected stack determines icon integration patterns (React components, Vue components, raw SVG, etc.).

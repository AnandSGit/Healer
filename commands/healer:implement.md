...
Run type checker, linter, and tests using the detected commands. Fix any failures using the Fix-Verify Cycle from `_enforcement.md`.
...
RED FLAGS — STOP AND REASSESS:
  ...
  → Go back to Step 2. Run the tool calls.

...
Follow the **Stack Auto-Detection Protocol** defined in `commands/_enforcement.md`. Cache results for the session. This determines:
...
Follow the Verification Protocol from `commands/_enforcement.md` before filling in any status. Use actual evidence, not placeholders.

...
Use the **Stack Auto-Detection Protocol** from `${CLAUDE_PLUGIN_ROOT}/shared/_enforcement.md`. Scan for manifest files and determine the full toolchain. Use the detected commands throughout.

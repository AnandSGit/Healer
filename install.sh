...
echo "═══════════════════════════════════════════════════"
echo "  Healer v5 — Universal Development Lifecycle Engine"
echo "  30 commands | 10 flow presets | Requirement traceability"
echo "═══════════════════════════════════════════════════"
echo ""
...
# Copy commands
echo "Installing 30 commands to $CLAUDE_COMMANDS..."
...
echo "  Commands:  $CLAUDE_COMMANDS/healer*.md (30 files)"
...
echo "    /healer:flow visual  # Visual design pipeline"
echo ""
